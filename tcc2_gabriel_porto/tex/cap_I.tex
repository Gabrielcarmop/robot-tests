...
\par Para que essa estratégia seja realmente eficaz, os testes não podem ser conduzidos como uma etapa isolada ou final do desenvolvimento. Eles precisam ser planejados desde o início do projeto e integrados ao fluxo de trabalho da equipe, tornando-se parte natural e contínua do ciclo de vida do software. Esse paradigma é fortemente defendido por metodologias ágeis e pela cultura DevOps, que promovem práticas como Integração Contínua (CI) e Entrega Contínua (CD), estimulando que a validação da qualidade ocorra em todas as fases do desenvolvimento, de forma automatizada e iterativa.
\par Assim, insere-se neste contexto a proposta deste trabalho, que explora a automação de testes em conjunto com mecanismos modernos de inteligência artificial e pipelines de CI/CD, demonstrando como essas abordagens podem elevar a confiabilidade, a rastreabilidade e a eficiência do processo de desenvolvimento de software.
