...
\textcolor{red}{[adcionar uma imagem e falar um pouco mais e apresentar exemplos 
explicar melhor como funciona.]}

    \item \textbf{Grafo de Causa e Efeito}
\par A analise do valor limite, é uma técnica que se baseia em pontos limites de uma faixa de dados, apresentando um abordagem simples, onde os erros costumam ocorrer nos pontos extremos das entradas. A partir disso, em vez de testar os valores típicos, o testador analisa os valores mais altos e baixos da amostra de dados. Essa técnica pode ser considerada um complemento para o particionamento por equivalência.  \cite{araujo2015}. \textcolor{red}{Nesta referência bibiográfica não é citado este critério de teste funcional. REVEJA.}
...
\begin{figure} [!ht]
    ...
    \label{fig:gfc}
\end{figure}
\textcolor{red}{[Qual é a fonte desta imagem?]}
...
\textcolor{red}{Esta imagem não faz parte desta referência bibliográfica, REVEJA.}
...
\begin{figure}[!ht]
    ...
    \caption{Modelo V de desenvolvimento de software \cite{modelov}.}
    \label{fig:modelo-v}
\end{figure}

\textcolor{red}{O link para esta imagem do Modelo V está quebrado, procure outra imagem cujo link esteja acessĩvel. Complementando, esta imagem não pode ficar solta aqui no texto. Você precisa fazer uma introdução aos níveis de teste e referênciar a imagem como um exemplo destes níveis.}
