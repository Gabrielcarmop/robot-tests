...
\subsection{Técnica de Teste Estrutural}
...
\subsection{Técnica de Teste Baseada em Defeitos}
\label{sub:tectestdef}

\par A Técnica de Teste Baseada em Defeitos é uma abordagem  que visa identificar vulnerabilidades no software por meio da introdução intencional de falhas. Em vez de se basear apenas em requisitos funcionais, essa Técnica busca avaliar como o software se comporta diante de erros, explorando suas fragilidades e limites.
...
Diferentes tipos de teste podem ser aplicados ao produto de sofware, nos seus diversos níveis de execução. Dentre os principais tipos de testes, pode-se destacar os seguintes:
