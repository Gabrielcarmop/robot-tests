...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{tcc2_gabriel_porto/fig/TesteCaixaBranca.png}
...
\subsubsection{Técnicas de Teste Baseada em Defeitos}
...
\textbackslash{}par Para isso, são utilizadas técnicas como \textit{Mutation Testing} , que realiza pequenas alterações no código, simulando erros comuns  e \textit{Fuzz Testing}, que fornece entradas aleatórias e inesperadas ao software. O objetivo é verificar se os testes conseguem detectar esses problemas e garantir que o softaware  continue operando corretamente mesmo em situações adversas.
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{tcc2_gabriel_porto//fig/Partição de equivalencia.png}
...
\begin{figure} [!ht]
    \centering
    \includegraphics[width=0.5\linewidth]{GrafoDeCausaEfeito.png}
...
Exemplo de Citação de Imagem. Figura 1 (Modelo V): \ref{fig:modelo-v}
