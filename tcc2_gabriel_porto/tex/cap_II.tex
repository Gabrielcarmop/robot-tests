...
\par O Grafo de Causa e Efeito, Figura \ref{fig:gce} ... \textcolor{red}{Descrever este criterio com base na referência adicionada à imagem. Na versão anterior a descrição aqui era a mesma do critério Análise do Valor Limite.}
