...
\begin{figure}[!ht]
    ...
    \caption{Ilustração do conceito de Teste de Caixa Preta \cite{blackboxtestingimg}.}
...
\begin{figure}[!ht]
   ...
   \caption{Ilustração do conceito de Teste de Caixa Branca \cite{whiteboxtestingimg}.}
...
\begin{figure}[!ht]
    ...
    \caption{Ilustração do conceito de Teste de Mutação \cite{mutationtestingimg}.}
